...
class SocialAgent(Agent):
    ...
    def _generate_system_prompt(self) -> str:
        ...
        Your story: {self.persona.synthesized_text}
    ...
    def start_conversation(
        ...
        try:
            ...
            for turn in range(num_turns):
                # Agent 1's turn
                message1 = agent1.generate_message(last_message, partner_name=agent2.name,)
                self.add_message(
                ...
                # Agent 2's turn
                message2 = agent2.generate_message(last_message, agent1.name)
                self.add_message(
